...
import et.ts.adapter.ListAdapter;
import et.ts.util.CommonUtils;
import et.ts.util.CustomChangeBounds;
import et.ts.util.StatusBarUtil;
import et.ts.view.MyNestedScrollView;
import et.ts.wyymusic.R;
import et.ts.wyymusic.databinding.ActivityMovieDetailBinding;
import jp.wasabeef.glide.transformations.BlurTransformation;

import static et.ts.util.StatusBarUtil.getStatusBarHeight;
...
public class NeteasePlaylistActivity extends AppCompatActivity {
    ...
    private ActivityMovieDetailBinding binding=null;
    // 这个是高斯图背景的高度
...
//        DebugUtil.error("----alpha:  " + alpha);
    ...
    public static void start(Activity context, ImageView imageView, boolean isRecyclerView) {
        ...
        Log.d("instance","2222222222222222222"+context);
        intent.putExtra(PARAM, isRecyclerView);
        Log.d("33333333333333","transition_book_img="+R.string.transition_book_img);
